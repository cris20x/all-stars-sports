...
public class AuthService {
    ...
    public void recuperarCuenta(
        ...
        if (request == null) {
            throw new RuntimeException(
                    "Los datos de recuperación son inválidos");
        }
        ...
        boolean claveValida =
                authRepository.verificarClaveRecuperacion(
                        request.getEmail(),
                        request.getClaveRecuperacion()
                );
        ...
        if (!claveValida) {
            throw new RuntimeException(
                    "La clave de recuperación es incorrecta");
        }
        ...
        authRepository.actualizarPassword(
                request.getEmail(),
                nuevaPasswordHash
        );
    }
